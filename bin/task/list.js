...
var listAction = function (val) { return __awaiter(void 0, void 0, void 0, function () {
    var seeds;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!val.seeds) return [3 /*break*/, 2];
            ...
            case 1:
                ...
                seeds.forEach(function (item) {
                    (0, lib_1.logger)(lib_1.LogType.Info, "seed\u5305\u540D\u79F0\uFF1A".concat(item));
                });
                return [2 /*return*/];
            case 2:
